...
Home Assistant integration for vehicles using the Geely Global / Geely International app (tested on Geely EX5).

Provides locks, climate, switches, selects, covers, buttons, sensors, binary sensors, and a device tracker.
